...
<!-- 	<div><input type="file" name="page"/></div> -->
		...
		<!-- <form  method="post" name="form" enctype="multipart/form-data" action="/Health/admin.php/level/inser" onSubmit="return beforeSubmit(this);"> -->
 ...
 <script>
	...
	<script>	
		...
		console.log(imgone);
 		$.ajax({
			type: "post",
			url: "/Health/admin.php/Level/inser",
			data: {			
				name:name,
				brief:brief,
