	...
	<div style="height:88%;width:100%">
			...
			<div style="height:100%;">
				<div class="right" >
					...
					<!--内容-->
				<div id="content" >
					<div  style="margin: 20px auto;width: 1000px;height: 600px;background:#999;" id="chat"></div>

<script src="/Health/library/dist/vue.js" type="text/javascript"></script>
<script src="/Health/library/dist/main.js" type="text/javascript"></script>
				</div>
